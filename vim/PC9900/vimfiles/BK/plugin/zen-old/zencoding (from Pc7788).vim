...
\                    ."<body>\n\t${child}|\n</body>\n"
\                    ."</html>",
\            'lorem' : "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas eu sagittis diam. Sed quis nibh lacus, vitae tempor risus. Aliquam pharetra, nisl at eleifend mollis, sapien arcu interdum lacus, eu faucibus dui leo non elit. Etiam ac purus nunc, non luctus dolor. Mauris semper commodo diam eu congue. Curabitur elementum quam vitae augue tristique quis bibendum diam semper. Vestibulum elementum, felis non sollicitudin porttitor, sapien enim luctus tortor, at luctus augue nunc quis purus. Donec id feugiat nisi. In convallis ipsum quis metus porta feugiat. Proin ac odio leo. Nullam non dolor arcu, at tincidunt nibh. Nam lobortis, lectus id imperdiet aliquam, lacus lacus lobortis diam, eu tincidunt felis est pretium ligula. In in velit quis risus viverra porttitor ut nec mi. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec velit risus, malesuada ut fermentum non, consequat nec sapien. Sed quis nibh ut nibh tristique molestie. Nullam placerat accumsan laoreet. Curabitur sit amet velit eros."
\            
\            
\        },
\        'default_attributes': {
